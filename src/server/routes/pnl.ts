    ...
    return {
      ...
      body: {
        ...
        expenses: {
          ...
          // Прошлый месяц по статьям — для показа % роста и раскрытия «что выросло».
          prev_breakdown: {
            payroll: previous.expensesBreakdown.payroll,
            marketing: previous.expensesBreakdown.marketing,
            tax: previous.tax,
            tax_payroll: previous.expensesBreakdown.tax_payroll,
            rent: previous.expensesBreakdown.rent,
            payment_commission: previous.expensesBreakdown.payment_commission,
            bank_services: previous.expensesBreakdown.bank_services,
            subscriptions: previous.expensesBreakdown.subscriptions,
            loan: previous.expensesBreakdown.loan,
            other_business: previous.expensesBreakdown.other_business,
          },
        },
        profit,
        margin_pct,
