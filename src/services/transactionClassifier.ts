...
- tax — налог с дохода: АУСН/УСН, ФНС, ЕНП, патент (налоги «от прибыли»)
- tax_payroll — зарплатные налоги: страховые взносы, НДФЛ с зарплат, ПФР/ФОМС
- rent — аренда помещения, офиса, склада, коворкинга
- payment_commission — комиссия эквайринга/платёжной системы (Продамус, Lava, эквайринг банка за приём оплат)
- bank_services — банковское обслуживание/РКО, тарифный пакет банка, лицензия ПК «Сервис Точка», комиссия по зарплатному проекту, комиссия за перевод/выплату
