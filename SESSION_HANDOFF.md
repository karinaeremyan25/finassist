...
_Обновлено: 2026-06-21. Этот файл — точка входа для продолжения работы. Прочитай его целиком перед началом._

> **АКТИВНАЯ СПЕКА: `SPEC_FinAssist_v2.2.md`** — уточнения Карины (налог/АУСН, деньги в пути доход+расход, комиссия Продамуса, возвраты, ФОТ по физ-картам Лилианы/списку людей, билеты→ФОТ кроме Карины и Токарь, счета/акты ООО, AI голосом правит счёт). Там же таблица аудита «что реализовано». Начинать с §10 (подтвердить ставку налога/объект) → Блоки A+B.
