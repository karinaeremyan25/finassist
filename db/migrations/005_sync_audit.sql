...
-- ─────────────────────────────────────────────────────────────
-- Расширение moddatetime (для триггера updated_at).
-- На Supabase расширения живут в схеме extensions (она уже в search_path).
-- Идемпотентно; на чистой БД создаёт схему и расширение.
-- ─────────────────────────────────────────────────────────────
